...
public:
    ...
    static bool checkCriteriaRY(Matcher::result_t &res, bool isIdentity, double evalThr, double seqIdThr, double seqIdThrRy, int alnLenThr, int covMode, float covThr);
...
private:
    ...
    // RY-mer space sequence identity threshold
    const double rySeqIdThr;

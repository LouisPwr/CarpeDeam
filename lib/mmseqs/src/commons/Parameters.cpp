...
Parameters::Parameters():
        ...
        //PARAM_MATCHER_CHOICE(PARAM_MATCHER_CHOICE_ID, "--kry-matcher", "Matcher choice", "extension clusters matcher choice (k or ry)", typeid(bool), (void *) &rymatcher, "", MMseqsParameter::COMMAND_PREFILTER | MMseqsParameter::COMMAND_CLUSTLINEAR | MMseqsParameter::COMMAND_EXPERT),

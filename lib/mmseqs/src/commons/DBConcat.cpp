            ...
            if (write) {
                ...
                if (takeLargerEntry == true) {
                    ...
                    if (dataSizeA >= dataSizeB) {
                        concatWriter->writeData(data, dataSizeA, newKey, thread_idx, wasExtended);
                    }
                } else {
                    concatWriter->writeData(data, dataSizeA, newKey, thread_idx, wasExtended);
                }

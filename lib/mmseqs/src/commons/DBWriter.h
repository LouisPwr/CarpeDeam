...
public:
    ...
    void writeEnd(unsigned int key, unsigned int thrIdx = 0, bool wasExtended = false, bool addNullByte = true, bool addIndexEntry = true);

    void writeData(const char *data, size_t dataSize, unsigned int key, unsigned int threadIdx = 0, bool wasExtended = false, bool addNullByte = true, bool addIndexEntry = true);

    static size_t indexToBuffer(char *buff1, unsigned int key, size_t offsetStart, size_t len, bool wasExtended = false);
    ...
    void writeIndexEntry(unsigned int key, size_t offset, size_t length, unsigned int thrIdx, bool wasExtended = false);

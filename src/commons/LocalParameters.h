...
private:
    LocalParameters() :
            ...
            PARAM_CORR_THRESH(PARAM_CORR_THRESH_ID, "--min-ryseq-id-corr-reads", "Seq. ident. in RY-space to increase precision of correction (ancient)" , "Range 0-1 (ancient)", typeid(float), (void *) &corrReadsRySeqId, "", MMseqsParameter::COMMAND_EXPERT),
            PARAM_CORR_THRESH_SEQID(PARAM_CORR_THRESH_SEQID_ID, "--min-seqid-corr-reads", "Seq. ident. to increase precision of correction (ancient)" , "Range 0-1 (ancient)", typeid(float), (void *) &corrReadsSeqId, "", MMseqsParameter::COMMAND_EXPERT),

...
void calc_likelihood(scorePerRes & scoredRes, char* querySeq, const char* targetSeq, std::vector<diNucleotideProb> & subDeamDiNuc, unsigned int maxAln, bool isRightOverlap, float randAlnPenal, diNucleotideProb & seq_err_match, diNucleotideProb & seq_err_mis);

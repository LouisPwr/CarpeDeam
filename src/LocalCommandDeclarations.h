...
extern int nuclassembleresult1(int argc, const char** argv, const Command &command);
extern int nuclassembleresult2(int argc, const char** argv, const Command &command);
